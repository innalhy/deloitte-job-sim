...
def convertFromFormat1 (jsonObject):
    ...
    # Create unified format (WITH NESTED data object)
    result = {
...
def convertFromFormat2 (jsonObject):
    # Convert ISO 8601 timestamp to milliseconds epoch
    ...
    # Unified format WITH NESTED data object
    result = {
...
def main (jsonObject):
    # Detect format: Format1 has no 'device' key
